...
$CONFIG['rag_pass']		=	'xpeedro20';		// SQL Ragnarok Password
$CONFIG['rag_db']			=	'xpeedbd';		// SQL Ragnarok Database name
$CONFIG['log_db']			=	'xpeedbd2';		// SQL Ragnarok Log Database name

$CONFIG['cp_serv']		=	'localhost';	// SQL CP Host
$CONFIG['cp_user']		=	'root';		// SQL CP User
$CONFIG['cp_pass']		=	'xpeedro20';		// SQL CP Password
...
//server name, rates
$CONFIG['name']			=	'XpeedRo CP';	// name of the server
$CONFIG['rate']			=	'10/10/10';		// rates of the server
date_default_timezone_set('Europe/Madrid');		// game server Timezone (useful if your webserver's timezone is different than game server).
$CONFIG['dynamic_info']		=	'1';			// Use info (rates) from the server itself?
$CONFIG['dynamic_name']		=	'XpeedRo CP';	// The name of the server in ragsrvinfo's server name column (Used for dynamic info)
$CONFIG['show_rates']		=	'1';			// Show rates below server status?

//map,char,login servers settings
$CONFIG['accip']			=	'151.80.37.7';	// Account/Login Server IP
$CONFIG['accport']		=	'6900';		// Account/Login Server Port
$CONFIG['charip']			=	'151.80.37.7';	// Char Server IP
$CONFIG['charport']		=	'6121';		// Char Server Port
$CONFIG['mapip']			=	'151.80.37.7';	// Zone/Map Server IP
